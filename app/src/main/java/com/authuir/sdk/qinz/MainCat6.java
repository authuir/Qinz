...
public class MainCat6 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReqHead.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(MainCat6.this, FridMainActivity.class);
                MainCat6.this.startActivityForResult(intent, 0);
            }
        });
    ...
    {
        Intent intent = new Intent();
        intent.setClass(MainCat6.this, MainReqDetailActivity.class);
        MainCat6.this.startActivityForResult(intent, 0);
    }
    ...
    public void onClick_Detail(View v)
    {
        Log.e("TAG", "CLICK");
        Intent intent = new Intent();
        intent.setClass(MainCat6.this, MainDetailActivity.class);
        MainCat6.this.startActivityForResult(intent, 0);
