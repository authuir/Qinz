...
public class MainCat3 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReqHead.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(MainCat3.this, FridMainActivity.class);
                MainCat3.this.startActivityForResult(intent, 0);
            }
        });
    ...
    {
        Intent intent = new Intent();
        intent.setClass(MainCat3.this, MainReqDetailActivity.class);
        MainCat3.this.startActivityForResult(intent, 0);
    }
    ...
    public void onClick_Detail(View v)
    {
        Log.e("TAG", "CLICK");
        Intent intent = new Intent();
        intent.setClass(MainCat3.this, MainDetailActivity.class);
        MainCat3.this.startActivityForResult(intent, 0);
