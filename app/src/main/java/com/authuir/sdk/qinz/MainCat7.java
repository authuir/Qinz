...
public class MainCat7 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReqHead.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(MainCat7.this, FridMainActivity.class);
                MainCat7.this.startActivityForResult(intent, 0);
            }
        });
    ...
    {
        Intent intent = new Intent();
        intent.setClass(MainCat7.this, MainReqDetailActivity.class);
        MainCat7.this.startActivityForResult(intent, 0);
    }
    ...
    public void onClick_Detail(View v)
    {
        Log.e("TAG", "CLICK");
        Intent intent = new Intent();
        intent.setClass(MainCat7.this, MainDetailActivity.class);
        MainCat7.this.startActivityForResult(intent, 0);
