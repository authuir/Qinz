...
public class MainCat4 extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mReqHead.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.setClass(MainCat4.this, FridMainActivity.class);
                MainCat4.this.startActivityForResult(intent, 0);
            }
        });
    ...
    {
        Intent intent = new Intent();
        intent.setClass(MainCat4.this, MainReqDetailActivity.class);
        MainCat4.this.startActivityForResult(intent, 0);
    }
    ...
    public void onClick_Detail(View v)
    {
        Log.e("TAG", "CLICK");
        Intent intent = new Intent();
        intent.setClass(MainCat4.this, MainDetailActivity.class);
        MainCat4.this.startActivityForResult(intent, 0);
